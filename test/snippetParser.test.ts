...
import { Scanner, TokenType, SnippetParser, Text, Placeholder, Variable, Marker, TextmateSnippet, Choice, FormatString, Transform } from './../src/snippetParser';
...
describe('SnippetParser', () => {
	...
	it('Parser, variables/placeholder with defaults', () => {
	...
	it('Parser, placeholder with choice', () => {
	...
	it('Parser, default placeholder values', () => {
	...
	it('backspace esapce in TM only, #16212', () => {
		const actual = new SnippetParser().text('Foo \\\\${abc}bar');
		assert.equal(actual, 'Foo \\bar');
	});

	it('colon as variable/placeholder value, #16717', () => {
	...
	it('TextmateSnippet#placeholder', () => {
